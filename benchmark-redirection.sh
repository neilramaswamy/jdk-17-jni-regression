...
# JDK 8
$(which java) -cp target/jni-threads-1.0-SNAPSHOT.jar org.ramaswamy.jdk17.Repro --log=false > jdk8.txt
...
# JDK 17
$(which java) -cp target/jni-threads-1.0-SNAPSHOT.jar org.ramaswamy.jdk17.Repro --log=false 2> /dev/null > jdk17.txt
# echo "Log file size is $(du ./logs/rocksdb-demo.log | awk '{print $1'})"
rm ./logs/rocksdb-demo.log
